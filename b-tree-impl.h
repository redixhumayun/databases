...
/**
 * @brief The size of this struct on my current compiler is 32 bytes (including padding)
 *
 */
typedef struct Row
{
...
#define _insert(pager, node, key, value, tx_id) \
    _Generic((value),                           \
             uint32_t                           \
             : _insert_into_leaf, void *        \
             : _insert_into_internal)(pager, node, key, value, tx_id)
